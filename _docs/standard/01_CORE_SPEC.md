...
# K-Product Scout — 최종 프로젝트 설계서 (v1.3)
...
> - v1.3 (2026-03-03): 가격 정책 업데이트 Standard $69 / Alpha $129, 브랜드명 KoreaScout 확정
...
**비즈니스 모델:** 3-Tier 구독 (Free / Standard $69 / Alpha $129)

**수익 목표 (Month 3):**
- Free: 500 users (유입 풀)
- Standard $69: 210 users = $14,490/month
- Alpha $129: 110 users = $14,190/month
- **합계: $28,680/month (~₩40,000,000)**
...
| **결제** | LemonSqueezy | 구독 결제($69/$129), 글로벌 세금 자동 처리, Merchant of Record |
...
| 전략 파트너 | 둘째 | Claude | 전략/설계, 01_CORE_SPEC 관리 |
...
| 구분 | Free $0 | Standard $69 | Alpha $129 |
|------|---------|-------------|-----------|
| 접근 시점 | 14일 딜레이 | 즉시 | 즉시 |
...
**전환 트리거:** "2주 늦게, 반만, 대충" → $69면 즉시+전부+상세

### 4-4. Standard — $69/month
...
| 1 | Product Identity | ✅ | ✅ | ✅ | — |
| 2 | Market Basic | ✅ | ✅ | ✅ | — |
| 3 | Market Premium | 🔒 | ✅ | ✅ | Standard $69 |
| 4 | Consumer & SEO | 🔒 | ✅ | ✅ | Standard $69 |
| 5 | Sourcing Intel | 🔒 | 🔒 | ✅ | Alpha $129 |
| 6 | Media (4K+바이럴) | 🔒 | 🔒 | ✅ | Alpha $129 |
| 7 | Navigation | ✅ | ✅ | ✅ | 동적 |
...
| 섹션 | 메시지 | CTA |
|------|--------|-----|
| Market Data | "Unlock profit margins, search trends, and global pricing intel." | Start Standard — $69/mo → |
| Consumer/SEO | "See exactly who's buying and which keywords drive sales." | Start Standard — $69/mo → |
| Sourcing | "You know it sells. Now get the supplier." | Upgrade to Alpha — $129/mo → |
| Media | "Watch the product video and see what went viral in Korea." | Upgrade to Alpha — $129/mo → |
...
| Feature | Free $0 | Standard $69 | Alpha $129 |
|---------|---------|-------------|-----------|
| 접근 시점 | 14일 딜레이 | 즉시 | 즉시 |
...
> **v1.3 — 2026년 3월 3일 확정**
> 가격: Standard $69/mo (무제한) / Alpha $129/mo (3,000명 한정)
> 상세 가격 전략: _docs/02_PRICING_STRATEGY.md 참조