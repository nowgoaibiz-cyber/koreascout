    ...
    <div className="rounded-lg border border-white/10 bg-white/[0.02] p-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="min-w-0">
          <p className="text-xs uppercase tracking-widest text-white/50 font-semibold">KR Price</p>
          <p className="text-lg font-mono font-semibold text-white tabular-nums">{krPrice}</p>
        </div>
        ...
        <div className="min-w-0 text-right">
          <p className="text-xs uppercase tracking-widest text-white/50 font-semibold">US Price</p>
          <p className="text-lg font-mono font-semibold text-white tabular-nums">{usPrice}</p>
        </div>
      </div>
    </div>
  );
