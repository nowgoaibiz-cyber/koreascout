...
export const SECTION_3_LOCKED_CTA = {
  ...
  cta: `Unlock Market Intelligence — ${PRICING.CURRENCY}${PRICING.ALPHA.monthly}/mo →`,
  href: "/pricing",
...
export const SECTION_STANDARD_CTA = {
  ...
  cta: `Start Alpha — ${PRICING.CURRENCY}${PRICING.ALPHA.monthly}/mo`,
  href: "/pricing",
  lockedFields: ["Profit multiplier", "Search volume", "Growth", "Global price", "SEO keywords"],
};
...
export const SECTION_4_LOCKED_CTA = {
  ...
  cta: `See What's Trending — ${PRICING.CURRENCY}${PRICING.ALPHA.monthly}/mo →`,
  href: "/pricing",
...
export const SECTION_ALPHA_SOURCING_CTA = {
  ...
  cta: `Unlock Logistics Intel — ${PRICING.CURRENCY}${PRICING.ALPHA_PLUS.monthly}/mo →`,
  href: "/pricing",
...
export const SECTION_ALPHA_MEDIA_CTA = {
  ...
  cta: `Unlock Media Vault — ${PRICING.CURRENCY}${PRICING.ALPHA_PLUS.monthly}/mo →`,
  href: "/pricing",
...
export const SECTION_ALPHA_SUPPLIER_CTA = {
  ...
  cta: `Get Supplier Contact — ${PRICING.CURRENCY}${PRICING.ALPHA_PLUS.monthly}/mo →`,
  href: "/pricing",
  lockedFields: [
