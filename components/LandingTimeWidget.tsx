...
export default function LandingTimeWidget() {
  return (
    <section className="bg-[#F8F7F4] py-24 px-6 transition-colors duration-500">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div
            className="bg-[#F8F7F4] border border-[#E8E6E1] border-l-4
          ...
          >
            ...
            <div className="border-t border-[#E8E6E1] mt-6 pt-6 space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-xs font-black text-[#1A1916]">
                  $129/month
                </span>
              </div>
              <div className="flex justify-between">
        ...
        {/* Disclaimer */}
        <div
          className="mt-8 border border-[#E8E6E1] rounded-xl px-6 py-4 bg-white
          max-w-3xl mx-auto"
        >
          <p className="text-xs font-medium text-[#9E9C98] leading-relaxed text-center">
            † HS Code classifications, MOQ figures, and compliance data
            provided by KoreaScout are pre-verified intelligence estimates
            designed to give your customs broker a 90% head start — not a legal
            guarantee. Always confirm with your licensed broker.
          </p>
        </div>
      </div>
    </section>
